...
public class GeneralUtilities {
	...
	/*
	 * public String createRandomNumber_Utility() { Random rand = new Random(); int
	 * uniqueID = rand.nextInt(1000000); String uniqueIDStr =
	 * String.valueOf(uniqueID); return uniqueIDStr; }
	 */
